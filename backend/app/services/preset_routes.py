...
_PRESET_DATA: list[dict] = [
    ...
    _preset(
        ...
        [
            ...
            _leg(2, "2026-07-03T10:00:00", "2026-07-03T13:00:00", "attraction", "塔桥 + 伦敦塔", 51.5055, -0.0754, "metro", 260, ["历史线最完整"], "Tower Hill"),
        ],
    ),
    _preset(
    ...
    _preset(
        ...
        [
            ...
            _leg(1, "2026-07-15T14:00:00", "2026-07-15T17:00:00", "attraction", "老特拉福德球场", 53.4631, -2.2913, "tram", 160, ["球迷很值得"], "Metrolink"),
    ...
    _preset(
        ...
        [
            ...
            _leg(2, "2026-08-12T18:00:00", "2026-08-12T20:00:00", "food", "特拉斯提弗列区", 41.8897, 12.4708, "tram", 110, ["晚餐和夜景很好结合"], "Tram 8"),
        ],
    ),
    _preset(
    ...
    _preset(
        ...
        [
            _leg(0, "2026-08-20T09:00:00", "2026-08-20T12:00:00", "attraction", "梵高博物馆", 52.3584, 4.8811, "tram", 160, ["预约是关键"], "Museumplein"),
            _leg(1, "2026-08-20T14:00:00", "2026-08-20T16:00:00", "shopping", "九条街区", 52.3731, 4.8836, "tram", 220, ["小众买手店多"], "Westermarkt"),
    ...
    _preset(
        ...
        [
            ...
            _leg(1, "2026-12-05T10:30:00", "2026-12-05T13:00:00", "attraction", "维州国立美术馆", -37.8226, 144.9689, "tram", 0, ["免费馆藏很强"], "免费电车区"),
