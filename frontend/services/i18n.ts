...
const zh: TranslationDict = {
  ...
  'plan.askingLocal': '正在咨询当地人推荐的隐藏宝藏…',
  'plan.balancingTime': '在时间、路step与体力间寻求最佳平衡…',
  'plan.optimizing': '正在努力规划中，AI 全力运转中…请耐心等待',
  'plan.rateLimited': '请求太频繁，请 {seconds} 秒后重试',
  'plan.rateLimitedGeneric': '请求太频繁，请稍后重试',
  'plan.modelUnavailable': 'AI 服务暂时不可用，请稍后重试',
  'plan.modelTimeout': 'AI 生成超时，请重试（预置路线极速写出，AI重试通常 10s 内完成）',
  'plan.allModelsFailed': '所有 AI 模型当前负载过高，请点击重试，或试试预置路线',
  ...
  'profile.deleteConfirm': '确定要删除该行程吗？',
  'profile.settings': '设置',
  ...
  'profile.name': '姓名',
  'profile.tagline': '个人签名',
  'profile.email': '邮箱',
  'profile.countriesVisited': '到访国家数',
  'profile.trips': '行程',
  'profile.saved': '收藏',
  'profile.reviews': '评价',
  ...
  'profile.noAlerts': '暂无价格提醒',
  'profile.setEmailHint': '设置价格提醒，降价时第一时间通知你',
  'profile.goSetAlert': '去设置提醒',
  'profile.to': '→',
...
const en: TranslationDict = {
  ...
  'plan.askingLocal': 'Consulting local hidden gems…',
  'plan.balancingTime': 'Finding the perfect balance of time, steps & energy…',
  'plan.optimizing': 'AI is working hard… please wait a moment',
  ...
  'plan.modelTimeout': 'AI timed out. Retry now — presets are instant, AI usually finishes in 10s',
  'plan.allModelsFailed': 'All AI models are overloaded. Tap Retry or try a preset route',
  ...
  'profile.deleteConfirm': 'Delete this itinerary?',
  ...
  'profile.noAlerts': 'No alerts yet',
  'profile.setEmailHint': 'Set a price alert to get notified when prices drop',
  'profile.goSetAlert': 'Set Alert',
  'profile.to': 'to',
